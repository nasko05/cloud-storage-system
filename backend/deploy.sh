...
aws s3 cp "$BUILD_DIR/upload-lambda.zip" "s3://$ARTIFACT_BUCKET/lambdas/upload-lambda.zip"
aws s3 cp "$BUILD_DIR/download-lambda.zip" "s3://$ARTIFACT_BUCKET/lambdas/download-lambda.zip"
